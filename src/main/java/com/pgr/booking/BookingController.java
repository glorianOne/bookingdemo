...
@Api(name = "Hotel Booking API", description = "Provides a list o methods that manage hotel bookings", stage = ApiStage.RC)
public class BookingController {
	...
	@ApiMethod(description = "Create  hote booking an save it to the database")
	...
	@ApiMethod(description = "Remove the hotel with the provided ID from the database")
